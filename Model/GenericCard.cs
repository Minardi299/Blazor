...
namespace MudBlazorWebApp1.Model.Gwallet
{
    public class GenericCard
    {
        ...
        public GenericObject newObject { get; set; }
        public GenericClass newClass { get; set; }
        ...
        public GenericCard(GenericPassObject genericObject, GenericPassClass genericPass)
        {
            this.newObject = genericObject.WalletObject;
            this.newClass = genericPass.WalletClass;
            /*keyFilePath = Environment.GetEnvironmentVariable(
        "GOOGLE_APPLICATION_CREDENTIALS") ?? "/path/to/key.json";*/
            keyFilePath = "Model\\dulcet-voyager-385103-4c4243a8107d.json";
            this.issuerId = genericObject.issuerId;
            this.classSuffix = genericObject.classSuffix;
            this.objectSuffix = genericObject.objectSuffix;
        }
        public void Auth()
        {
        ...
        public string CreateJWTNewObjects()
        {
            ...
            // See link below for more information on required properties
            // https://developers.google.com/wallet/generic/rest/v1/genericclass
            GenericClass newClass = this.newClass;
            GenericObject newObject = this.newObject;
                ...
                ImageModulesData = new List<ImageModuleData>
    {
        ...
        public async void BatchCreateObjects()
        {
            ...
            for (int i = 0; i < 3; i++)
            {
                ...
                // See link below for more information on required properties
                // https://developers.google.com/wallet/generic/rest/v1/genericobject
                //TODO : change the generic object to the same as the 2 others?
